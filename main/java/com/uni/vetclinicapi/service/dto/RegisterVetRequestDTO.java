 ...
 */
@Schema(description = "This DTO holds information about a User that's trying to register.", allowableValues = {"username", "email", "password","fName","lName","typeOfVet"})
@AllArgsConstructor
@Data
public class RegisterVetRequestDTO {
